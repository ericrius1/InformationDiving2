...
G.CurveDot.$menuItem =  $('<div>').addClass('item').text("2 : Curve Dots").appendTo($('#menu'));

G.CurveDot.prototype = Object.create(G.Primitive.prototype);

G.CurveDot.prototype.constructor = G.CurveDot;


G.CurveDot.prototype.spawn = function(){
